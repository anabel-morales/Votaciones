 ...
 * @author Anabe
 */
@WebServlet(name = "ControladorListarPartidos", urlPatterns = {"/ControladorListarPartidos"})
public class ControladorListarPartidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Partido> ArrayPartidos = new DAOperaciones().getPartidos(Conexion);
