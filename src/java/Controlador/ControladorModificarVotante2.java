 ...
 * @author Anabe
 */
public class ControladorModificarVotante2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                new DAOperaciones().modificarVotante(objVotante, conexion);
                session.setAttribute("objVotante", objVotante);
                response.sendRedirect("./VISTAS/Solucion.jsp?codigo=modificar-datos");
            } catch (ApplicationErrorException AE) {
                response.sendRedirect("./VISTAS/Solucion.jsp?codigo=error-modificar-votante");
            } catch (ClassNotFoundException | SQLException ex) {
                response.sendRedirect("./VISTAS/Solucion.jspcodigo=error2-modificar-votante");
            }
        }
    }
