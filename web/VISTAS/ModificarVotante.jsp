<%-- 
    Document   : ModificarVotante
    Created on : 28-abr-2020, 18:28:23
    Author     : Anabe
--%>
...
<html>
    ...
    <body>
        <div class="page">
            <div class="container">
                <div class="left">
                    <div class="login">MODIFICAR</div>
                    <div class="eula">¿Estás seguro de modificar tus datos? Recuerda que no puedes hacerlo si has votado.</div>
                </div>
                <div class="right">
                    ...
                    <div class="form">
                        <form action="../ControladorModificarVotante" method="POST">
